...
* SSTR CASE
         ...
         origin = 0;
         n('nq','sstr','index1')=a.l;
         n('nz','sstr','index1')=b.l;
         n('nc','sstr','index1')=c.l;
         plane('sstr','index1',k1,k2)= n('nq','sstr','index1')*qtot(k1) + n('nz','sstr','index1')*dz(k2) + n('nc','sstr','index1');
...
*        0
         ...
         solve approx_plan us LP min of;
         n('nq','grpr','index1')=a.l;
         n('nz','grpr','index1')=b.l;
         n('nc','grpr','index1')=c.l;
         plane('grpr','index1',k1,k2)= n('nq','grpr','index1')*qtot(k1) + n('nz','grpr','index1')*dz(k2) + n('nc','grpr','index1');
...
*        0
         ...
         solve approx_plan us LP min of;
         origin = 0; weight = 0;
         n('nq','prgr','index1')=a.l;
         n('nz','prgr','index1')=b.l;
         n('nc','prgr','index1')=c.l;
         plane('prgr','index1',k1,k2)= n('nq','prgr','index1')*qtot(k1) + n('nz','prgr','index1')*dz(k2) + n('nc','prgr','index1');
